...
execute if score craft_toggle_ craft_toggle_ matches 1 run give @s fishing_rod[damage=63,custom_name='[{"text":"NUKE POWER 3 (aim)","italic":false}]',custom_data={nuke_aim_3:1b}]
